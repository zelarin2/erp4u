        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Description Tax Rate</label>
                        <div class="form-group col-sm-10">
                            <input name="descriptionTaxRate" class="form-control" type="text" value="{{$taxRate->descriptionTaxRate}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Tax Rate</label>
                        <div class="form-group col-sm-10">
                            <input name="taxRate" class="form-control" type="number" value="{{$taxRate->taxRate}}">
                        </div>
                    </div>
